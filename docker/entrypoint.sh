...
sed -i "s@https://pipedapi.coldforge.xyz@${HTTP_MODE}://pipedapi.kavin.rocks@g" /usr/share/nginx/html/assets/*
sed -i "s/pipedapi.coldforge.xyz/${BACKEND_HOSTNAME}/g" /usr/share/nginx/html/assets/*
